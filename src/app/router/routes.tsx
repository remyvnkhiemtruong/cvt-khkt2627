...
export const APP_ROUTES: Record<string, RouteDefinition> = {
  ...
  'portfolio-list': { id:'portfolio-list', path:'/portfolios', title:'Bài đã làm', allowedRoles:['student','teacher','peer','researcher','admin'] },
  ...
  'student-analytics': { id:'student-analytics', path:'/student/analytics', title:'Tiến bộ', allowedRoles:['student','teacher'] },
  'teacher-dashboard': { id:'teacher-dashboard', path:'/teacher/overview', title:'Giáo viên', allowedRoles:['teacher','admin'] },
  'teacher-review': { id:'teacher-review', path:'/teacher/review', title:'Chấm bài', allowedRoles:['teacher','peer','admin'] },
  'assignment-builder': { id:'assignment-builder', path:'/teacher/assignment-builder', title:'Tạo nhiệm vụ', allowedRoles:['teacher','admin'] },
  'rubric-management': { id:'rubric-management', path:'/teacher/rubrics', title:'Rubric', allowedRoles:['teacher','admin','researcher'] },
  'literature-texts': { id:'literature-texts', path:'/teacher/literature-texts', title:'Tác phẩm', allowedRoles:['teacher','admin','student','researcher'] },
  ...
  'admin-view': { id:'admin-view', path:'/admin/audit', title:'Quản trị', allowedRoles:['admin'] },
  'ai-workspace': { id:'ai-workspace', path:'/ai/workspace', title:'Góp ý AI', allowedRoles:['ai','teacher','admin'] }
};
