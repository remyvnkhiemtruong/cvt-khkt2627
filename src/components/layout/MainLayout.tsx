...
export const MainLayout: React.FC<MainLayoutProps> = ({ currentView, onNavigate, onLogout, children }) => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 font-sans text-slate-900" data-app-name="Học tốt Ngữ Văn">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:left-2 focus:top-2 focus:z-50 focus:rounded-md focus:bg-primary-700 focus:px-4 focus:py-2 focus:font-medium focus:text-white focus:outline-none focus:ring-2 focus:ring-white">Chuyển thẳng đến nội dung chính</a>
